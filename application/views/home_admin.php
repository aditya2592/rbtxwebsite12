...
<label>
<input type="text" name="tabname" id="" value="<?php echo $page[0]->menu_name; ?>">
Page Name</label><br>
<label>

<input type="text" name="tabslug" id="" value="<?php echo $page[0]->slug; ?>">
Slug</label><br>
<label>
<textarea class="ckeditor" type="text" name="tabcontent" ><?php echo $page[0]->content; ?></textarea>
Content</label><br>

<label>
<input type="text" name="tabcat" id="" value="<?php echo $page[0]->category; ?>">
